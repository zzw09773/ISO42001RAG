...
### Task 5: render + app — 頁面與 FastAPI 路由
...
### Task 6: Dockerfile、compose 服務與上線煙霧測試
...
**Interfaces:**
- Consumes: Task 5 的 `service.app:app` 與 `ADMIN_RUNTIME=1`。
...
### Task 8: Playwright 端到端驗證

**Files:**
- Create（scratchpad，不入版控）：無——直接以 Playwright MCP 操作實站

**Interfaces:**
- Consumes: Task 6 上線的 `http://localhost:8300/`、Task 7 的儀表板。
