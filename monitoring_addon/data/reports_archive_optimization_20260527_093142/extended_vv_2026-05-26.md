...
**產生時間**：2026-05-26T11:39:30.668048+00:00
**資料集筆數**：30
**評估 K**：5
**整體結果**：⚠️ INCONCLUSIVE
...
**當前 Hit Rate**：`0.0`  →  ⚠️ (gating metric)
...
|------|------|------|-------------|------|
| **Hit Rate** | **0.0** | **0.9** | ✅ 業務目標 | ⚠️ |
| Precision@K | 0.0 | 0.5 | info | ⚠️ |
| Recall@K | 0.0 | 0.5 | info | ⚠️ |
| F1@K | 0.0 | 0.5 | info | ⚠️ |
| MRR | 0.0 | 0.4 | info | ⚠️ |
| MAP | 0.0 | 0.4 | info | ⚠️ |
| 評估筆數 | 0 | — | — |
| 跳過筆數（無 ground truth） | 30 | — | — |
